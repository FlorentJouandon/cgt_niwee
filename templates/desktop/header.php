...
<div id ="header" class="container-fluid">
    <div class="header container-fluid row bg-white text-center">
        <div class="col-2"></div>
        <div id="logo" class="col-8 py-3">
            <img src="public\img\logo\logo-confederation-cgt-france.svg" alt="CGT France">
            <img src="public\img\logo\logo-ara.png" alt="CGT Auvergne-Rhône-Alpes">
            <img src="public\img\logo\logo-cgt63.png" alt="CGT 63">
            <img src="public\img\logo\IHSLogo.png" alt="Institut historique sociale">
            <img src="public\img\logo\logo-cgt-jeunes_aia.png" alt="CGT jeunes-AIA">
            <img src="public\img\logo\Logo-cgt-INDECOSA.jpeg" alt="CGT INDECOSA">
            <img src="public\img\logo\retraites.png" alt="CGT retraites">
        </div>
    </div>    
...
<!---------------- Search ---------------->
    <div id="info">
        <div id="search">
            <input type="text" placeholder="Recherche" class="text-end text-white">
            <button type="submit" class="search"><img src="public/img/icons/search.svg" alt="icon_search"></button>
        </div>

        <div id="tab-calendar">
            <div class="bg-calendar">
                <p class="tab-calendar text-center">Calendrier</p>
            </div>
        </div>
    </div>
...
<!---------------- MENU ---------------->
    <div id="menu" class="menu container-fluid">
        <div id="tab-accueil" class="row">
            <a href="Accueil"><div class="bg-menu"></div></a>
